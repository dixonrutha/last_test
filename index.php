...
<html lang="en">
<head>
    <title>First Choicecarwash</title>
...
<div class="main-agile">
    <h1>First Choice Car Wash Under Construction</h1>
                ...
                <div class="agileits-timer">
                    <div class="clock">
                        ...
                        <div class="column">
                            ...
                            <div class="text">From glocalhost git </div>
                        </div>
                        <div class="timer"></div>
                        <div class="column">
    ...
    <!-- copyright -->
    <div class="copyright">
        <p> © FirstChoice . All rights reserved | Design by </p>
    </div>
    <!-- //copyright -->
</div>
<!-- //main -->
